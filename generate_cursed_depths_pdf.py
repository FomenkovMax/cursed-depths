...
gnome_classes = [
    {
        ...
        'stages': [
            ...
            },
            {
                'name': 'Страж Предела',
                'abilities': [
                    ('Несокрушимый', '1 раз за бой при получении смертельного урона выживает с 1 ХП и получает щит 25% макс. ХП.', False, ''),
            ...
            },
            {
                'name': 'Живой Закон',
                'abilities': [
                    ('Стена Торнака', 'На 2 хода: перенаправляет на себя 30% урона, предназначенного одному союзнику (урон снижается на 30%).', False, ''),
        ...
        'stages': [
            {
                'name': 'Обвальщик',
                'abilities': [
                    ('Трещина', 'Игнорирует 25% брони цели на 3 хода.', False, ''),
            ...
            },
            {
                ...
                'abilities': [
                    ...
                    ('Косой удар', 'Мощная атака, игнорирующая 40% брони; если у врага нет щита — доп. 50% урона.', False, ''),
                ]
            },
        ]
    },
        ...
        'stages': [
            {
                'name': 'Хранитель нити',
                'abilities': [
                    ('Живая нить', 'Восстанавливает 20% ХП себе или союзнику + реген на 3 хода (5% ХП/ход).', False, ''),
            ...
            },
            {
                'name': 'Голос Айлет',
                'abilities': [
                    ('Древесный покров', 'На 2 хода все союзники в группе получают реген 8% ХП/ход и +20% сопротивления к дебаффам.', False, ''),
                    ('Возвращение к корням', 'Воскрешает одного павшего союзника с 30% ХП (1 раз за бой).', False, ''),
                ]
            },
        ]
    },
        ...
        'stages': [
            {
                ...
                'abilities': [
                    ...
                    ('Цикл луны', 'Каждые 3 хода меняет стойку: Тень (+20% уклонение) / Кровь (+25% крит) / Яд (6% ХП/ход на 3 хода).', False, ''),
    ...
    },
    {
        ...
        'stages': [
            ...
            },
            {
                'name': 'Эхо Пустоты',
                'abilities': [
                    ('Вакуум', 'Снимает все баффы с одного врага и наносит урон за каждый (15% от силы баффа).', False, 'Снимает максимум 2 баффа.'),
                    ('Поглощение тепла', 'Каждый ход крадёт 3% ХП у текущего врага и передаёт себе.', True, ''),
                ]
            },
        ]
    },
        ...
        'stages': [
            ...
            },
            {
                ...
                'abilities': [
                    ...
                    ('Боевая стойка', 'Каждый 4-й удар гарантированный крит.', True, ''),
                ]
            },
            {
                'name': 'Маршал Пепла',
    ...
    },
    {
        ...
        'stages': [
            ...
            },
            {
                'name': 'Фантом',
                'abilities': [
                    ('Казнь из тени', 'Если у врага ниже 30% ХП, удар из невидимости наносит колоссальный урон (на обычных врагов — мгновенная казнь).', False, '25% от макс. ХП босса, 1 раз за бой.'),
    ...
    },
    {
        ...
        'stages': [
            ...
            },
            {
                'name': 'Владыка теней',
                'abilities': [
                    ('Бездна', 'Проклятие на одного врага: -30% ко всем характеристикам на 3 хода + Владыка получает 30% от урона, нанесённого этому врагу, как исцеление.', False, '-15% характеристик на 2 хода на боссах.'),
        ...
        'stages': [
            {
                ...
                'abilities': [
                    ...
                    ('Ловушка', 'Урон + обездвиживание на 1 ход.', False, 'Замедление 30% на 1 ход.'),
            ...
            },
            {
                'name': 'Охотник',
                'abilities': [
                    ('Двойная ловушка', 'Ставит 2 ловушки: следующая атака врага активирует ловушку — урон + замедление 20% на 2 хода.', False, ''),
        ...
        'stages': [
            {
                'name': 'Каменнокожий',
                'abilities': [
                    ('Базальтовая шкура', 'Снижает урон следующего удара на 35%.', False, ''),
            ...
            },
            {
                'name': 'Каменный легат',
                'abilities': [
                    ('Каменный панцирь', 'На 2 хода +40% брони, но -15% скорости.', False, ''),
            ...
            },
            {
                'name': 'Нерушимый',
                'abilities': [
                    ('Живая крепость', 'На 3 хода перенаправляет 50% урона, получаемого одним союзником, на себя (урон снижается на 20%).', False, ''),
        ...
        'stages': [
            {
                'name': 'Пепельный гладиатор',
                'abilities': [
                    ('Метеоритный удар', 'Тратит 15% собственного ХП, наносит 180% урона.', False, ''),
            ...
            },
            {
                'name': 'Выживший',
                'abilities': [
                    ('Испытание огнём', 'Поджигает себя на 2 хода (5% ХП/ход), но атаки наносят +40% урона.', False, ''),
            ...
            },
            {
                ...
                'abilities': [
                    ...
                    ('Феникс', '1 раз за бой при смерти восстанавливается с 30% ХП.', True, ''),
                ]
            },
        ]
    },
...
undead_classes = [
    {
        ...
        'stages': [
            ...
            },
            {
                'name': 'Владыка Мора',
                'abilities': [
                    ('Легион праха', 'Призывает 3 скелетов из пустоты (25% ХП/урона, существуют 1 ход).', False, 'Вместо призыва — наносит урон тьмой равный 20% от макс. ХП босса.'),
        ...
        'stages': [
            ...
            },
            {
                ...
                'abilities': [
                    ...
                    ('Усиление заразы', 'Каждый ход действия яда на враге увеличивает его силу на 2%.', True, '1% на боссах.'),
                ]
            },
            {
                'name': 'Архилич',
                'abilities': [
                    ...
                    ('Распад реальности', 'Враги с 3+ дебаффами теряют 10% макс. ХП каждый ход.', True, '5% на боссах.'),
                ]
            },
        ]
    },
    ...
    },
    {
        ...
        'stages': [
            ...
            },
            {
                ...
                'abilities': [
                    ('Разгром', 'Мощнейшая атака: огромный урон + враг теряет 20% брони на 3 хода.', False, '10% на боссах.'),
                    ('Диктат силы', 'Враги с пониженной защитой получают +15% урона от всех источников.', True, '+8% на боссах.'),
                ]
            },
        ]
    },
...
story.append(Paragraph('Расы, Классы и Способности', cover_subtitle_style))

...
export interface BossFightState {
  ...
  activeEffects: { kind: 'player_damage_buff' | 'enemy_damage_debuff' | 'enemy_dot' | 'on_block_counter_active' | 'debuff_amplify' | 'player_dodge_buff' | 'summon_damage'; percent: number; turnsRemaining: number }[];

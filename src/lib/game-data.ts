...
export const ITEMS: Item[] = [
  ...
  { id: 'leather_armor', nameRu: 'Кожаная броня', nameEn: 'Leather Armor', type: 'armor', gearSlot: 'body', rarity: 'common', stats: { defense: 2 }, descriptionRu: 'Кожа выделана наспех — руками того, кто не рассчитывал прожить достаточно, чтобы доделать лучше.', descriptionEn: 'Simple leather armor.', icon: '🦺', value: 15 },
  { id: 'chainmail', nameRu: 'Кольчуга', nameEn: 'Chainmail', type: 'armor', gearSlot: 'body', rarity: 'uncommon', stats: { defense: 4 }, descriptionRu: 'Кольца сплетены плотно, по счёту гномьей мастерской, что закрылась ещё до того, как гномы ушли в горы.', descriptionEn: 'Chainmail of steel rings.', icon: '🛡️', value: 60 },
  { id: 'dwarven_plate', nameRu: 'Дварфийская латная броня', nameEn: 'Dwarven Plate', type: 'armor', gearSlot: 'body', rarity: 'rare', stats: { defense: 7, vitality: 1 }, descriptionRu: 'Тяжёлая броня дварфийской ковки.', descriptionEn: 'Heavy armor of dwarven make.', icon: '🛡️', value: 250 },
  { id: 'shadow_cloak', nameRu: 'Плащ Теней', nameEn: 'Shadow Cloak', type: 'armor', gearSlot: 'body', rarity: 'rare', stats: { defense: 3, dexterity: 2 }, descriptionRu: 'Плащ, скрывающий во тьме.', descriptionEn: 'A cloak that hides in darkness.', icon: '🧥', value: 200 },
  { id: 'dragonscale_armor', nameRu: 'Драконья чешуя', nameEn: 'Dragonscale Armor', type: 'armor', gearSlot: 'body', rarity: 'epic', stats: { defense: 10, strength: 1, vitality: 2 }, descriptionRu: 'Броня из чешуи дракона.', descriptionEn: 'Armor made from dragon scales.', icon: '🐉', value: 800 },
  { id: 'celestial_robe', nameRu: 'Небесная мантия', nameEn: 'Celestial Robe', type: 'armor', gearSlot: 'body', rarity: 'epic', stats: { defense: 4, intellect: 3, willpower: 2 }, descriptionRu: 'Мантия, благословлённая небесами.', descriptionEn: 'Robe blessed by the heavens.', icon: '✨', value: 700 },
  { id: 'crown_armor', nameRu: 'Броня Короны', nameEn: 'Crown Armor', type: 'armor', gearSlot: 'body', rarity: 'legendary', stats: { defense: 14, strength: 2, vitality: 3, willpower: 2 }, descriptionRu: 'Легендарная броня, носящая печать Короля.', descriptionEn: "Legendary armor bearing the King's seal.", icon: '👑', value: 2000 },
  { id: 'first_dragon_scale', nameRu: 'Чешуя Первого Дракона', nameEn: 'Scale of the First Dragon', type: 'armor', gearSlot: 'body', rarity: 'legendary', stats: { defense: 16, strength: 2, vitality: 3 }, descriptionRu: 'Чешуя дракона, выкованного самим Веларионом. Ещё хранит жар его безумия.', descriptionEn: 'A scale from the dragon forged by Velarion himself. It still holds the heat of his madness.', icon: '🐉', value: 2200 },
  { id: 'petrified_law_shard', nameRu: 'Осколок Окаменевшего Закона', nameEn: 'Shard of Petrified Law', type: 'armor', gearSlot: 'body', rarity: 'legendary', stats: { defense: 18, vitality: 4, willpower: 2 }, descriptionRu: 'Кусок бога, обратившегося в камень. Почти невозможно пробить.', descriptionEn: 'A piece of a god turned to stone. Nearly impossible to break.', icon: '🗿', value: 3200 },

  // === ARMOR: HEAD (шлем/шляпа/венец) ===
  { id: 'torn_hood', nameRu: 'Рваный капюшон', nameEn: 'Torn Hood', type: 'armor', gearSlot: 'head', rarity: 'common', stats: { defense: 1 }, descriptionRu: 'Снят с того, кому он больше не понадобится. Дыры зашиты, но не все.', descriptionEn: 'A torn hood, patched but functional.', icon: '🥷', value: 12 },
  { id: 'iron_cap', nameRu: 'Железная шапка', nameEn: 'Iron Cap', type: 'armor', gearSlot: 'head', rarity: 'common', stats: { defense: 2 }, descriptionRu: 'Простой купол из клёпаного железа. Держит удар лучше, чем выглядит.', descriptionEn: 'Simple riveted iron cap.', icon: '⛑️', value: 18 },
  { id: 'hunters_hood', nameRu: 'Капюшон охотника', nameEn: "Hunter's Hood", type: 'armor', gearSlot: 'head', rarity: 'uncommon', stats: { defense: 2, dexterity: 1 }, descriptionRu: 'Сшит из шкур зверья Корневой Рощи — не шумит даже на сухой листве.', descriptionEn: 'Hood made from Root Grove hides.', icon: '🎯', value: 65 },
  { id: 'scholars_circlet', nameRu: 'Обруч писца', nameEn: "Scholar's Circlet", type: 'armor', gearSlot: 'head', rarity: 'uncommon', stats: { defense: 1, intellect: 2 }, descriptionRu: 'Обруч архивариуса, что переписывал Библию мира до тех пор, пока чернила не кончились сами.', descriptionEn: 'Circlet of a scribe-archivist.', icon: '🎓', value: 70 },
  { id: 'dwarven_helm', nameRu: 'Гномий шлем', nameEn: 'Dwarven Helm', type: 'armor', gearSlot: 'head', rarity: 'rare', stats: { defense: 5, vitality: 1 }, descriptionRu: 'Кован в той же кузне, что и Дварфийская латная броня — по тому же счёту, что уже никто не ведёт.', descriptionEn: 'Helm from the same forge as the Dwarven Plate.', icon: '🪖', value: 260 },
  { id: 'void_mask', nameRu: 'Маска Пустоты', nameEn: 'Void Mask', type: 'armor', gearSlot: 'head', rarity: 'epic', stats: { defense: 6, intellect: 2, willpower: 1 }, descriptionRu: 'Маска не скрывает лицо — она немного стирает его, взамен на взгляд, видящий чуть дальше.', descriptionEn: 'A mask that slightly erases its wearer.', icon: '👺', value: 720 },
  { id: 'kings_diadem', nameRu: 'Диадема Короля', nameEn: "King's Diadem", type: 'armor', gearSlot: 'head', rarity: 'legendary', stats: { defense: 9, strength: 2, willpower: 2 }, descriptionRu: 'Диадема того же Короля, чья Броня и Осколок Короны уже гуляют по рукам мародёров.', descriptionEn: "Diadem of the same King as the Crown Armor.", icon: '👑', value: 2100 },
  { id: 'crown_of_ash', nameRu: 'Пепельная корона', nameEn: 'Crown of Ash', type: 'armor', gearSlot: 'head', rarity: 'mythic', stats: { defense: 12, strength: 3, vitality: 2, willpower: 2 }, descriptionRu: 'Корона Пробуждённого Исполина Пепла — снятая с воплощения, что пало, но воскреснет снова.', descriptionEn: 'Crown of the Awakened Ash Colossus.', icon: '👑', value: 5200 },

  // === ARMOR: HANDS (перчатки/рукавицы/наручи) ===
  { id: 'worn_gloves', nameRu: 'Потёртые перчатки', nameEn: 'Worn Gloves', type: 'armor', gearSlot: 'hands', rarity: 'common', stats: { attack: 1 }, descriptionRu: 'Кожа продавлена по форме чужой руки — новый владелец донашивает чужую хватку.', descriptionEn: 'Gloves worn thin by a stranger.', icon: '🧤', value: 12 },
  { id: 'leather_bracers', nameRu: 'Кожаные наручи', nameEn: 'Leather Bracers', type: 'armor', gearSlot: 'hands', rarity: 'common', stats: { defense: 1 }, descriptionRu: 'Простая защита предплечий — от блока клинком, а не от Скверны.', descriptionEn: 'Simple forearm protection.', icon: '🧤', value: 14 },
  { id: 'iron_gauntlets', nameRu: 'Железные рукавицы', nameEn: 'Iron Gauntlets', type: 'armor', gearSlot: 'hands', rarity: 'uncommon', stats: { defense: 2, strength: 1 }, descriptionRu: 'Тяжёлые, неудобные, надёжные — три слова, которыми гномы описывают всё хорошее снаряжение.', descriptionEn: 'Heavy, reliable iron gauntlets.', icon: '🧤', value: 68 },
  { id: 'nimble_gloves', nameRu: 'Ловкие перчатки', nameEn: 'Nimble Gloves', type: 'armor', gearSlot: 'hands', rarity: 'uncommon', stats: { dexterity: 2 }, descriptionRu: 'Пальцы свободны почти до кончиков — для тех, кому важнее не потерять хватку на тетиве.', descriptionEn: 'Gloves that keep the fingertips free.', icon: '🧤', value: 72 },
  { id: 'runed_vambraces', nameRu: 'Наручи с рунами', nameEn: 'Runed Vambraces', type: 'armor', gearSlot: 'hands', rarity: 'rare', stats: { defense: 3, intellect: 2 }, descriptionRu: 'Руны выжжены, а не вырезаны — тот, кто их наносил, явно спешил закончить до темноты.', descriptionEn: 'Vambraces branded with runes.', icon: '📿', value: 270 },
  { id: 'orcish_fists', nameRu: 'Кулаки орка', nameEn: 'Orcish Fists', type: 'armor', gearSlot: 'hands', rarity: 'epic', stats: { attack: 5, strength: 2 }, descriptionRu: 'Шипастые рукавицы клана Грумгара — снятые с побеждённого, а не выкованные заново.', descriptionEn: "Spiked gauntlets of Grumgar's clan.", icon: '🧤', value: 740 },
  { id: 'grip_of_the_forgotten', nameRu: 'Хватка Забытого', nameEn: 'Grip of the Forgotten', type: 'armor', gearSlot: 'hands', rarity: 'legendary', stats: { attack: 7, strength: 3, vitality: 1 }, descriptionRu: 'Имя владельца стёрлось из Библии мира — осталась только хватка, что не разжалась даже после смерти.', descriptionEn: 'A grip that outlived its owner\'s name.', icon: '🦾', value: 2050 },
  { id: 'gauntlets_of_the_broken_oath', nameRu: 'Рукавицы Сломанной Клятвы', nameEn: 'Gauntlets of the Broken Oath', type: 'armor', gearSlot: 'hands', rarity: 'mythic', stats: { attack: 10, strength: 4, defense: 4 }, descriptionRu: 'Пара к Молоту Сломанной Клятвы — предавший бог гнома-титана всё ещё сжимает эти рукавицы во сне.', descriptionEn: 'The match to the Hammer of the Broken Oath.', icon: '🦾', value: 5100 },

  // === ARMOR: LEGS (сапоги/поножи/сандалии) ===
  { id: 'cloth_sandals', nameRu: 'Матерчатые сандалии', nameEn: 'Cloth Sandals', type: 'armor', gearSlot: 'legs', rarity: 'common', stats: { defense: 1 }, descriptionRu: 'Подошва протёрлась почти насквозь — но идти пока ещё можно.', descriptionEn: 'Well-worn cloth sandals.', icon: '👡', value: 10 },
  { id: 'traveling_boots', nameRu: 'Дорожные сапоги', nameEn: 'Traveling Boots', type: 'armor', gearSlot: 'legs', rarity: 'common', stats: { dexterity: 1 }, descriptionRu: 'Прошли не одну дорогу Пепельного Края — швы держатся из чистого упрямства.', descriptionEn: 'Boots that have seen many roads.', icon: '👢', value: 14 },
  { id: 'sturdy_greaves', nameRu: 'Крепкие поножи', nameEn: 'Sturdy Greaves', type: 'armor', gearSlot: 'legs', rarity: 'uncommon', stats: { defense: 2, vitality: 1 }, descriptionRu: 'Ковка простая, но честная — ни одного слабого шва.', descriptionEn: 'Honestly forged greaves.', icon: '👢', value: 66 },
  { id: 'swift_boots', nameRu: 'Быстрые сапоги', nameEn: 'Swift Boots', type: 'armor', gearSlot: 'legs', rarity: 'uncommon', stats: { dexterity: 2 }, descriptionRu: 'Подошва зачарована на лёгкость шага — след почти не остаётся в пепле.', descriptionEn: 'Boots enchanted for a lighter step.', icon: '👢', value: 74 },
  { id: 'dwarven_greaves', nameRu: 'Гномьи поножи', nameEn: 'Dwarven Greaves', type: 'armor', gearSlot: 'legs', rarity: 'rare', stats: { defense: 4, strength: 1 }, descriptionRu: 'Третья часть того же дварфийского комплекта, что Плита и Шлем — редко доходит целиком.', descriptionEn: 'The third piece of the dwarven set.', icon: '🦿', value: 265 },
  { id: 'shadowstep_boots', nameRu: 'Сапоги теневого шага', nameEn: 'Shadowstep Boots', type: 'armor', gearSlot: 'legs', rarity: 'epic', stats: { dexterity: 3, instinct: 2 }, descriptionRu: 'Каждый шаг на мгновение оставляет вторую, ложную тень — достаточно, чтобы сбить прицел.', descriptionEn: 'Boots that cast a false second shadow.', icon: '👢', value: 730 },
  { id: 'greaves_of_the_last_stand', nameRu: 'Поножи Последнего Рубежа', nameEn: 'Greaves of the Last Stand', type: 'armor', gearSlot: 'legs', rarity: 'legendary', stats: { defense: 8, vitality: 3, willpower: 1 }, descriptionRu: 'Носил тот, кто держал рубеж до последнего — не потому что мог победить, а потому что не мог уйти.', descriptionEn: 'Worn by one who held the line to the end.', icon: '🦿', value: 2080 },
  { id: 'boots_of_the_fallen_pillar', nameRu: 'Сапоги Павшего Столпа', nameEn: 'Boots of the Fallen Pillar', type: 'armor', gearSlot: 'legs', rarity: 'mythic', stats: { defense: 10, vitality: 4, dexterity: 2 }, descriptionRu: 'Выкованы из того, что осталось от одного из четырёх падших Столпов — тяжелее, чем кажутся.', descriptionEn: 'Forged from the remains of a fallen Pillar.', icon: '🦿', value: 5150 },

  // === ACCESSORIES: RING (кольца — два слота) ===
  { id: 'copper_ring', nameRu: 'Медное кольцо', nameEn: 'Copper Ring', type: 'accessory', gearSlot: 'ring', rarity: 'common', stats: { hp: 5 }, descriptionRu: 'Чара внутри давно ослабла, но ещё держится — как обещание, которое не смогли выполнить полностью, но и не бросили.', descriptionEn: 'Simple copper ring with a ward charm.', icon: '💍', value: 10 },
  { id: 'ring_of_focus', nameRu: 'Кольцо Сосредоточения', nameEn: 'Ring of Focus', type: 'accessory', gearSlot: 'ring', rarity: 'uncommon', stats: { intellect: 1, mp: 5 }, descriptionRu: 'Носившие его держали ум ясным даже там, где Скверна пыталась спутать мысли в узел.', descriptionEn: 'A ring that keeps the mind clear.', icon: '💍', value: 75 },
  { id: 'ring_power', nameRu: 'Кольцо Силы', nameEn: 'Ring of Power', type: 'accessory', gearSlot: 'ring', rarity: 'rare', stats: { strength: 2, attack: 3 }, descriptionRu: 'Кольцо, дающее невероятную силу.', descriptionEn: 'Ring granting incredible power.', icon: '💍', value: 200 },
  { id: 'ring_of_the_wild_hunt', nameRu: 'Кольцо Дикой Охоты', nameEn: 'Ring of the Wild Hunt', type: 'accessory', gearSlot: 'ring', rarity: 'epic', stats: { instinct: 3, dexterity: 2 }, descriptionRu: 'Снято с охотника Хребта Грумгара, что гнал добычу дольше, чем та могла бежать.', descriptionEn: "A ring taken from a Grumgar's Spine hunter.", icon: '💍', value: 690 },
  { id: 'unborn_chieftain_seal', nameRu: 'Печать Нерождённого Вождя', nameEn: 'Seal of the Unborn Chieftain', type: 'accessory', gearSlot: 'ring', rarity: 'legendary', stats: { strength: 3, instinct: 3, hp: 30 }, descriptionRu: 'Печать вождя, чьё объединение кланов так и не состоялось. Тяжёлая, как несбывшаяся клятва.', descriptionEn: "The seal of a chieftain whose unification of the clans never came to pass. Heavy as an unfulfilled oath.", icon: '🩸', value: 2600 },
  { id: 'gatekeeper_key', nameRu: 'Ключ Привратника', nameEn: 'Key of the Gatekeeper', type: 'accessory', gearSlot: 'ring', rarity: 'legendary', stats: { strength: 2, intellect: 2, willpower: 2, hp: 30 }, descriptionRu: 'Ключ существа, что охраняет вход в Глубь и подстраивается под любую атаку.', descriptionEn: 'A key from the being that guards the entrance to the Depths and adapts to any attack.', icon: '🗝️', value: 2800 },

  // === ACCESSORIES: AMULET (один слот на шею) ===
  { id: 'wooden_talisman', nameRu: 'Деревянный талисман', nameEn: 'Wooden Talisman', type: 'accessory', gearSlot: 'amulet', rarity: 'common', stats: { hp: 5 }, descriptionRu: 'Вырезан наспех из ветки, что ещё помнила, каково это — зеленеть.', descriptionEn: 'Roughly carved wooden talisman.', icon: '🪵', value: 10 },
  { id: 'amulet_vitality', nameRu: 'Амулет Жизни', nameEn: 'Amulet of Vitality', type: 'accessory', gearSlot: 'amulet', rarity: 'uncommon', stats: { hp: 15, vitality: 1 }, descriptionRu: 'Носили на груди достаточно долго, чтобы металл впитал тепло тела — вместе с частью его упрямства жить.', descriptionEn: 'Amulet that enhances vitality.', icon: '📿', value: 80 },
  { id: 'arcane_pendant', nameRu: 'Тайная подвеска', nameEn: 'Arcane Pendant', type: 'accessory', gearSlot: 'amulet', rarity: 'rare', stats: { intellect: 2, mp: 10 }, descriptionRu: 'Подвеска, концентрирующая магическую энергию.', descriptionEn: 'Pendant concentrating magical energy.', icon: '🔮', value: 250 },
  { id: 'ashen_amulet', nameRu: 'Пепельный амулет Хранителя', nameEn: "Keeper's Ashen Amulet", type: 'accessory', gearSlot: 'amulet', rarity: 'rare', stats: { willpower: 2, hp: 15 }, descriptionRu: 'Амулет падшего жреца Велариона, ещё хранящий отголосок веры.', descriptionEn: "Amulet of a fallen priest of Velarion, still echoing with faith.", icon: '📿', value: 220 },
  { id: 'ailet_tear', nameRu: 'Слеза Айлет', nameEn: 'Tear of Ailet', type: 'accessory', gearSlot: 'amulet', rarity: 'rare', stats: { willpower: 2, intellect: 1, hp: 10 }, descriptionRu: 'Застывшая слеза богини, всё ещё хранящая отголосок исцеления.', descriptionEn: "A frozen tear of the goddess, still echoing with healing.", icon: '💧', value: 230 },
  { id: 'oath_shield_shard', nameRu: 'Осколок Щита Клятвы', nameEn: 'Shard of the Oath Shield', type: 'accessory', gearSlot: 'amulet', rarity: 'rare', stats: { vitality: 2, hp: 15 }, descriptionRu: 'Обломок щита, что раскалывался и восстанавливался тысячи раз. Ещё хранит клятву.', descriptionEn: 'A shard of a shield shattered and reforged a thousand times. It still holds the oath.', icon: '🛡️', value: 240 },
  { id: 'first_fall_dust', nameRu: 'Пыль Первого Падения', nameEn: 'Dust of the First Fall', type: 'accessory', gearSlot: 'amulet', rarity: 'rare', stats: { willpower: 2, instinct: 2, hp: 15 }, descriptionRu: 'Горсть праха с того самого мгновения, когда мир раскололся. Ещё помнит, каким он был.', descriptionEn: 'A handful of dust from the very moment the world broke. It still remembers what it was.', icon: '⏳', value: 260 },
  { id: 'lucky_charm', nameRu: 'Талисман Удачи', nameEn: 'Lucky Charm', type: 'accessory', gearSlot: 'amulet', rarity: 'epic', stats: { dexterity: 2, instinct: 2, hp: 10 }, descriptionRu: 'Талисман, приносящий удачу в бою.', descriptionEn: 'Charm bringing luck in battle.', icon: '🍀', value: 500 },
  { id: 'witness_eye', nameRu: 'Око Первого Свидетеля', nameEn: 'Eye of the First Witness', type: 'accessory', gearSlot: 'amulet', rarity: 'epic', stats: { instinct: 3, willpower: 2, hp: 20 }, descriptionRu: 'Застывшее око духа, видевшего Падение. Носитель иногда слышит его крик.', descriptionEn: 'The frozen eye of the spirit who witnessed the Fall. Its wearer sometimes hears its scream.', icon: '👁️', value: 650 },
  { id: 'echo_thorn_crown', nameRu: 'Терновый венец Эха', nameEn: "Echo's Thorn Crown", type: 'accessory', gearSlot: 'amulet', rarity: 'epic', stats: { willpower: 3, instinct: 2, hp: 20 }, descriptionRu: 'Венец из терний, что носила Эхо Айлет — прекрасный и ядовитый одновременно.', descriptionEn: 'A thorn crown worn by the Echo of Ailet — beautiful and poisonous at once.', icon: '🥀', value: 680 },
  { id: 'crown_fragment', nameRu: 'Осколок Короны', nameEn: 'Crown Fragment', type: 'accessory', gearSlot: 'amulet', rarity: 'legendary', stats: { strength: 3, intellect: 3, hp: 25 }, descriptionRu: 'Фрагмент Короны Проклятого Короля.', descriptionEn: "Fragment of the Cursed King's Crown.", icon: '👑', value: 3000 },
  { id: 'first_risen_crown', nameRu: 'Корона Первого Восставшего', nameEn: 'Crown of the First Risen', type: 'accessory', gearSlot: 'amulet', rarity: 'legendary', stats: { willpower: 3, instinct: 3, hp: 25 }, descriptionRu: 'Корона того, кто умер вместе с миром и вернулся раньше всех остальных.', descriptionEn: 'The crown of the one who died with the world and returned before all others.', icon: '👑', value: 2400 },
  { id: 'kessara_mirror_shard', nameRu: 'Осколок Зеркала Кессары', nameEn: "Shard of Kessara's Mirror", type: 'accessory', gearSlot: 'amulet', rarity: 'legendary', stats: { instinct: 3, willpower: 3, hp: 30 }, descriptionRu: 'Осколок зеркала, что показывало вашу идеальную версию. Оно всё ещё немного видит вас насквозь.', descriptionEn: 'A shard of the mirror that showed your perfect self. It still sees through you, just a little.', icon: '🪞', value: 2900 },
  { id: 'ailet_pulsing_heart', nameRu: 'Пульсирующее Сердце', nameEn: 'Pulsing Heart', type: 'accessory', gearSlot: 'amulet', rarity: 'legendary', stats: { vitality: 3, willpower: 3, hp: 40 }, descriptionRu: 'Орган богини, ставший паразитом. Даже вырванное, оно продолжает биться.', descriptionEn: 'An organ of a goddess turned parasite. Even torn out, it keeps beating.', icon: '💗', value: 3000 },
  ...
  { id: 'blueprint_crown_of_ash', nameRu: 'Чертёж: Пепельная корона', nameEn: 'Blueprint: Crown of Ash', type: 'blueprint', rarity: 'mythic', stats: {}, descriptionRu: 'Изучите, чтобы навсегда открыть рецепт Пепельной короны.', descriptionEn: 'Learn to permanently unlock the Crown of Ash recipe.', icon: '📜', value: 0 },
  { id: 'blueprint_gauntlets_broken_oath', nameRu: 'Чертёж: Рукавицы Сломанной Клятвы', nameEn: 'Blueprint: Gauntlets of the Broken Oath', type: 'blueprint', rarity: 'mythic', stats: {}, descriptionRu: 'Изучите, чтобы навсегда открыть рецепт Рукавиц Сломанной Клятвы.', descriptionEn: 'Learn to permanently unlock the Gauntlets of the Broken Oath recipe.', icon: '📜', value: 0 },
  { id: 'blueprint_boots_fallen_pillar', nameRu: 'Чертёж: Сапоги Павшего Столпа', nameEn: 'Blueprint: Boots of the Fallen Pillar', type: 'blueprint', rarity: 'mythic', stats: {}, descriptionRu: 'Изучите, чтобы навсегда открыть рецепт Сапог Павшего Столпа.', descriptionEn: 'Learn to permanently unlock the Boots of the Fallen Pillar recipe.', icon: '📜', value: 0 },
...
export const ENEMIES: EnemyTemplate[] = [
  ...
  { id: 'fortress_ash_golem', nameRu: 'Пепельный голем крепости', nameEn: 'Fortress Ash Golem', hp: 45, ac: 13, attack: 8, damage: '1d10+3', xp: 48, gold: 25, lootTable: [{ itemId: 'iron_ore', chance: 0.5 }, { itemId: 'dwarven_plate', chance: 0.0225 }, { itemId: 'dwarven_helm', chance: 0.0225 }], locationId: 'ashen_fortress', isBoss: false, icon: '🗿' },
  ...
  { id: 'arena_champion', nameRu: 'Чемпион арены', nameEn: 'Arena Champion', hp: 50, ac: 15, attack: 11, damage: '1d10+5', xp: 55, gold: 28, lootTable: [{ itemId: 'dwarven_plate', chance: 0.045 }, { itemId: 'steel_sword', chance: 0.105 }, { itemId: 'ring_power', chance: 0.036 }, { itemId: 'runed_vambraces', chance: 0.036 }], locationId: 'oath_hall', isBoss: false, icon: '🪓' },
  ...
  { id: 'broodmother_wyrm', nameRu: 'Матриарх выводка', nameEn: 'Broodmother Wyrm', hp: 62, ac: 16, attack: 13, damage: '2d6+5', xp: 65, gold: 30, lootTable: [{ itemId: 'dragon_scale', chance: 0.135 }, { itemId: 'ignira_fang', chance: 0.0176 }, { itemId: 'orcish_fists', chance: 0.0176 }], locationId: 'dragon_nests', isBoss: false, icon: '🐲' },

  // Обсидиановый лабиринт (Level 6)
  { id: 'obsidian_golem', nameRu: 'Обсидиановый голем', nameEn: 'Obsidian Golem', hp: 65, ac: 18, attack: 13, damage: '2d6+5', xp: 68, gold: 30, lootTable: [{ itemId: 'iron_ore', chance: 0.4 }, { itemId: 'void_crystal', chance: 0.0176 }, { itemId: 'void_mask', chance: 0.0176 }], locationId: 'obsidian_labyrinth', isBoss: false, icon: '🗿' },
  ...
  { id: 'cathedral_guardian', nameRu: 'Страж собора', nameEn: 'Cathedral Guardian', hp: 75, ac: 18, attack: 16, damage: '2d8+5', xp: 80, gold: 36, lootTable: [{ itemId: 'dwarven_plate', chance: 0.045 }, { itemId: 'greater_health', chance: 0.21 }, { itemId: 'dwarven_greaves', chance: 0.045 }], locationId: 'bone_cathedral', isBoss: false, icon: '⛪' },
  ...
  { id: 'gladiator_champion', nameRu: 'Чемпион-гладиатор', nameEn: 'Gladiator Champion', hp: 80, ac: 18, attack: 17, damage: '2d6+6', xp: 85, gold: 38, lootTable: [{ itemId: 'dwarven_plate', chance: 0.054 }, { itemId: 'grumgar_fang', chance: 0.004 }, { itemId: 'lucky_charm', chance: 0.0132 }, { itemId: 'kings_diadem', chance: 0.004 }], locationId: 'blood_arena', isBoss: false, icon: '🏆' },
  ...
  { id: 'ritual_guardian', nameRu: 'Страж ритуала', nameEn: 'Ritual Guardian', hp: 88, ac: 19, attack: 18, damage: '2d8+6', xp: 92, gold: 42, lootTable: [{ itemId: 'void_crystal', chance: 0.022 }, { itemId: 'shadowstep_boots', chance: 0.022 }, { itemId: 'ring_of_the_wild_hunt', chance: 0.022 }], locationId: 'skull_trail', isBoss: false, icon: '🗿' },
...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  ...
  { id: 'craft_crown_of_ash', nameRu: 'Сковать Пепельную корону', nameEn: 'Forge the Crown of Ash', materials: [{ itemId: 'crown_shard', quantity: 1 }, { itemId: 'dragon_scale', quantity: 3 }, { itemId: 'void_crystal', quantity: 2 }], result: { itemId: 'crown_of_ash', quantity: 1 }, icon: '👑', tier: 3, minLevel: 14, requiresBlueprintId: 'blueprint_crown_of_ash' },
  { id: 'craft_gauntlets_broken_oath', nameRu: 'Сковать Рукавицы Сломанной Клятвы', nameEn: 'Forge the Gauntlets of the Broken Oath', materials: [{ itemId: 'crown_shard', quantity: 1 }, { itemId: 'iron_ore', quantity: 6 }, { itemId: 'shadow_essence', quantity: 3 }], result: { itemId: 'gauntlets_of_the_broken_oath', quantity: 1 }, icon: '🦾', tier: 3, minLevel: 14, requiresBlueprintId: 'blueprint_gauntlets_broken_oath' },
  { id: 'craft_boots_fallen_pillar', nameRu: 'Сковать Сапоги Павшего Столпа', nameEn: 'Forge the Boots of the Fallen Pillar', materials: [{ itemId: 'crown_shard', quantity: 1 }, { itemId: 'void_crystal', quantity: 3 }, { itemId: 'dragon_scale', quantity: 2 }], result: { itemId: 'boots_of_the_fallen_pillar', quantity: 1 }, icon: '🦿', tier: 3, minLevel: 14, requiresBlueprintId: 'blueprint_boots_fallen_pillar' },
];
